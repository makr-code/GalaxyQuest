-- ────────────────────────────────────────────────────────────────────────────────
-- Faction Species & Avatar Design Seed
-- Defines color palettes, portrait prompts, and logo guidelines for character generation.
-- Run this after schema.sql and migrate_v2.sql during deployment.
-- ────────────────────────────────────────────────────────────────────────────────
...
INSERT INTO faction_species (
    ...
    'military',
    '#1a3d2a', '#2d5f3f', '#8b6914',  -- male: dark green, bronze
    '#00c851', '#00e6ff', '#ffd700',  -- female: emerald, turquoise, gold
...
INSERT INTO faction_species (
    ...
    'diplomacy',
    '#001a66', '#9966ff', '#00ffff',  -- male: deep blue, violeta, cyan
    '#e6b3ff', '#ff66ff', '#e6ccff',  -- female: lavender, magenta, soft purple
...
INSERT INTO faction_species (
    ...
    'research',
    '#e6f2ff', '#b3d9ff', '#4d94ff',  -- male: white-blue, silver
    '#ffe6cc', '#fff9e6', '#ffffcc',  -- female: gold, amber, white
...
INSERT INTO faction_species (
    ...
    'production',
    '#1a1a00', '#664d00', '#cc0000',  -- male: black-green, dark red
    '#ffcc00', '#00ff99', '#00cc99',  -- female: gold, bright green, turquoise
...
INSERT INTO faction_species (
    ...
    'archive',
    '#0d1f4d', '#4d7a99', '#c0c0c0',  -- male: cobalt, crystal-gray, platinum
    '#ffb3d9', '#e6ccff', '#e6f2ff',  -- female: rose-gold, amethyst, periwinkle
...
INSERT INTO faction_species (
    ...
    'espionage',
    '#2a2a2a', '#0d66cc', '#0db3ff',  -- male: smoke-gray, ice-blue
    '#f0f0f0', '#e6b3ff', '#00ffff',  -- female: misty-white, lavender, cyan
...
ALTER TABLE faction_species ADD INDEX idx_species_code (species_code);
...
-- SELECT COUNT(*) as species_count, GROUP_CONCAT(display_name SEPARATOR ', ') as species FROM faction_species;
