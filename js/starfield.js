...
(async function () {
  ...
  async function ensureDeps() {
    ...
    if (!window.GalaxyCameraController) {
      await loadScript('js/galaxy-camera-controller.js?v=20260329p85');
    }
    if (!window.GQTextureManager) {
      await loadScript('js/texture-manager.js?v=20260329p1');
    }
    if (!window.GQGeometryManager) {
      await loadScript('js/geometry-manager.js?v=20260329p1');
    }
    if (!window.GQMaterialFactory) {
      await loadScript('js/material-factory.js?v=20260329p1');
    }
    if (!window.GQLightRigManager) {
      await loadScript('js/light-rig-manager.js?v=20260329p1');
    }
    if (!window.Galaxy3DRenderer) {
      await loadScript('js/galaxy-renderer-core.js?v=20260329p94');
    }
    if (!window.Galaxy3DRenderer) {
